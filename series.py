...
class MetricModels:
    def __init__(self, series, predictions):
        ...
        model_Residuals = [{'name': 'Prophet Val 15%', 'residual': prophet_Residual},
                           {'name': 'Prophet Val 20%', 'residual': prophet_Residual_20},
                           {'name': 'Prophet Média Val', 'residual': prophet_Residual_Mean},
                           {'name': 'CatBoost', 'residual': catBoost_Residual},
                           {'name': 'Prophet + CatBoost', 'residual': residual_Prophet_CatBoost},
                           {'name': "Prophet + CatBoost + FourTheta", 'residual': residual_Prophet_CatBoost_FourTheta}]

        eval_tests_n_models(model_Residuals)
